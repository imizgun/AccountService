    ...
    ) : BackgroundService
{
    ...
    private static string RoutingKeyFor(Type t) => t.Name switch
    {
        ...
        nameof(TransferCompleted) => "money.transfer.completed",
        nameof(TransactionDeleted) => "money.transaction.deleted",
        nameof(TransactionUpdated) => "money.transaction.updated",
